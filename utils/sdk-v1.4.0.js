! function e(t, n, r) {
  ...
  5: [function(e, t, n) {
    (function(n) {
      ...
      var f = e("lodash._arraycopy"),
        ...
        k = /\w*$/,
        L = {};
      L[b] = L["[object Array]"] = L[T] = L[v] = L[_] = L[j] = L[A] = L[S] = L[I] = L[R] = L[w] = L[m] = L[E] = L[O] = L[D] = L[P] = L[x] = L[C] = !0, L["[object Error]"] = L[g] = L["[object Map]"] = L["[object Set]"] = L["[object WeakMap]"] = !1;
      ...
      ! function(e, r) {
        ...
        function R(e, t, n, r) {
          var o = c(n),
            ...
            a = void 0;
          if (o) {
            if ((i = I(n, r)) === De) a = i.error, i.error = null;
        ...
        var tt = (ze = {
          ...
          reject: se,
          map: ue
        }, ve(ze, "async", We), ve(ze, "filter", he), ze);
        t.default = tt, t.asap = pe, t.cast = Xe, t.Promise = ke, t.EventTarget = we, t.all = J, t.allSettled = X, t.race = W, t.hash = te, t.hashSettled = oe, t.rethrow = ie, t.defer = ae, t.denodeify = Y, t.configure = a, t.on = _e, t.off = ge, t.resolve = ce, t.reject = se, t.map = ue, t.async = We, t.filter = he, Object.defineProperty(t, "__esModule", {
          value: !0
        })
      })
  ...
  54: [function(e, t, n) {
    "use strict";
    var r = e("./baas");
    r.auth = e("./baasRequest").auth, r.handleUserInfo = e("./auth").handleUserInfo, r.ContentGroup = e("./ContentGroup"), r.File = e("./File"), r.FileCategory = e("./FileCategory"), r.GeoPoint = e("./GeoPoint"), r.GeoPolygon = e("./GeoPolygon"), r.getWXACode = e("./getWXACode"), r.invokeFunction = e("./invokeFunction"),
      r.login = e("./auth").login, r.logout = e("./auth").logout, r.order = e("./order"), r.pay = e("./pay"), r.Promise = e("./promise"), r.Query = e("./Query"), r.request = e("./request"), r.storage = e("./storage"), r.TableObject = e("./TableObject"), r.uploadFile = e("./uploadFile"), r.User = e("./User"), r.wxDecryptData = e("./wxDecryptData"), r.wxReportTicket = e("./templateMessage").wxReportTicket, e("./baasRequest").createRequestMethod(), "undefined" != typeof wx && (wx.BaaS = r), t.exports = r
  }, {
    "./ContentGroup": 36,
    "./File": 37,
    "./FileCategory": 38,
